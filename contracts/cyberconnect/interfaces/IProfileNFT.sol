...
interface IProfileNFT is IProfileNFTEvents {
     ...
     */
    function initialize(address _owner, string calldata name, string calldata symbol) external;
     ...
     */
    function setSubscribeData(uint256 profileId, string calldata tokenURI, address mw, bytes calldata data) external;
     ...
     * @dev Only owner's signature works.
     */
    function setPrimaryProfileWithSig(uint256 profileId, DataTypes.EIP712Signature calldata sig) external;
     ...
     */
    function setOperatorApproval(uint256 profileId, address operator, bool approved) external;
     ...
     */
    function getMetadata(uint256 profileId) external view returns (string memory);
     ...
     */
    function getOperatorApproval(uint256 profileId, address operator) external view returns (bool);
     ...
     */
    function getHandleByProfileId(uint256 profileId) external view returns (string memory);
     ...
     */
    function getPrimaryProfile(address user) external view returns (uint256 profileId);
     ...
     * @return address The middleware address.
     */
    function getEssenceMw(uint256 profileId, uint256 essenceId) external view returns (address);
