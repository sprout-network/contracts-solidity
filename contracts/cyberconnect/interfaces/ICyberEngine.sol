...
interface ICyberEngine is ICyberEngineEvents {
     ...
     */
    function initialize(address _owner, RolesAuthority _rolesAuthority) external;
    ...
    function createNamespace(
        DataTypes.CreateNamespaceParams calldata params
    ) external returns (address profileProxy, address subBeacon, address essBeacon);
     ...
     */
    function setProfileMw(address namespace, address mw, bytes calldata data) external;
     ...
     */
    function getNameByNamespace(address namespace) external view returns (string memory);
     ...
     */
    function getProfileMwByNamespace(address namespace) external view returns (address);
