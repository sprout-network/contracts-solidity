...
interface IMBEvents {
     ...
     */
    event Initialize(address indexed owner, address indexed boxAddr, string name, string symbol, string uri);
     ...
     */
    event OpenBox(address indexed to, uint256 indexed boxId);
}
