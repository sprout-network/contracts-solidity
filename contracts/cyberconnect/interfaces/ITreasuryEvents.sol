...
interface ITreasuryEvents {
     ...
     */
    event AllowCurrency(address indexed currency, bool indexed preAllowed, bool indexed newAllowed);
     ...
     */
    event SetTreasuryAddress(address indexed preTreasuryAddress, address indexed treasuryAddress);
     ...
     */
    event SetTreasuryFee(uint16 indexed preTreasuryFee, uint16 indexed treasuryFee);
}
